    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-400 text-sm">Start building your chatbot for free</p>
        </div>

        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
          {/* Benefits */}
          <ul className="mb-6 space-y-1.5 text-sm text-slate-400">
            {['Free tier — no credit card required', '100 messages included', 'Deploy in under 5 minutes'].map((benefit) => (
